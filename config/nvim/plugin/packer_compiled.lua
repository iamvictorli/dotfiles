...
_G.packer_plugins = {
  ...
  ["nvim-treesitter-textobjects"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/opt/nvim-treesitter-textobjects",
  ...
  ["telescope-fzf-native.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = true,
    path = "/Users/victor/.local/share/nvim/site/pack/packer/opt/telescope-fzf-native.nvim",

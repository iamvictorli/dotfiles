...
require('packer').startup(function(use)
  ...
  use { -- Autocompletion
    'hrsh7th/nvim-cmp',
    requires = { 'hrsh7th/cmp-nvim-lsp', 'L3MON4D3/LuaSnip', 'saadparwaiz1/cmp_luasnip', 'rafamadriz/friendly-snippets', 'hrsh7th/cmp-buffer', 'hrsh7th/cmp-path', 'hrsh7th/cmp-nvim-lua' },
  }
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'astro', 'bash', 'comment', 'c', 'cmake', 'cpp', 'css', 'diff', 'dockerfile', 'git_rebase', 'gitattributes', 'gitcommit', 'go', 'graphql', 'help', 'html', 'http', 'javascript', 'jsdoc', 'json', 'json5', 'jsonc', 'lua', 'make', 'php', 'phpdoc', 'prisma', 'python', 'rust', 'scss', 'svelte', 'terraform', 'tsx', 'todotxt', 'toml', 'tsx', 'typescript', 'vim', 'vue', 'yaml' },
